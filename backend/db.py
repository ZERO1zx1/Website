...
class SupabaseDB:
    ...
    def _initialize(self):
        ...
        # The Flask server is the trusted boundary for Auth/profile/progress operations.
        # Prefer the service-role key and never expose it through a browser response.
        supabase_key = os.getenv('SUPABASE_SERVICE_ROLE_KEY') or os.getenv('SUPABASE_KEY')

        if not supabase_url or not supabase_key:
            raise RuntimeError("SUPABASE_URL and SUPABASE_SERVICE_ROLE_KEY must be set for backend database operations")
